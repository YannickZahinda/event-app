import { FaLightbulb, FaSmile, FaShieldAlt, FaUniversalAccess, FaLeaf } from "react-icons/fa";
...
<section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 bg-[#4A1316] text-white p-6">
  ...
  <div className="flex flex-col items-center text-center bg-[#3C0F12] p-4 rounded-lg shadow-lg">
    <FaSmile size={50} className="text-[#FFD700] mb-4" />
  ...
  {/* Card */}
  <div className="flex flex-col items-center text-center bg-[#3C0F12] p-4 rounded-lg shadow-lg">
    <FaLightbulb size={50} className="text-[#FFD700] mb-4" />
    <h3 className="text-lg font-semibold mb-2">Innovation continue</h3>
    <p className="text-sm leading-relaxed">
  ...
  {/* Card */}
  <div className="flex flex-col items-center text-center bg-[#3C0F12] p-4 rounded-lg shadow-lg">
    <FaShieldAlt size={50} className="text-[#FFD700] mb-4" />
  ...
  {/* Card */}
  <div className="flex flex-col items-center text-center bg-[#3C0F12] p-4 rounded-lg shadow-lg">
    <FaUniversalAccess size={50} className="text-[#FFD700] mb-4" />
  ...
  {/* Card */}
  <div className="flex flex-col items-center text-center bg-[#3C0F12] p-4 rounded-lg shadow-lg">
    <FaLeaf size={50} className="text-[#FFD700] mb-4" />
